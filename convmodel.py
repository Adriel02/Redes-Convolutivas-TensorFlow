...
#example_batch_valid, label_batch_valid = dataSource(["valid/validcirculo/*.jpg", "valid/validcuadrado/*.jpg", "valid/validtriangulo/*.jpg"], batch_size=batch_size)
#example_batch_test, label_batch_test = dataSource(["test/testcirculo/*.jpg", "test/testcuadrado/*.jpg", "test/testtriangulo/*.jpg"], batch_size=batch_size)
